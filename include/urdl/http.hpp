 ...
 *
 * @par Example
 * To set the authorization for an object of class @c urdl::istream:
 * @code
 * urdl::istream is;
 * is.set_option(urdl::http::authorization("authorization string"));
 * is.open("http://www.boost.org");
 * @endcode
 *
 * To set the authorization for an object of class @c urdl::read_stream:
 * @code
 * urdl::read_stream stream;
 * stream.set_option(urdl::http::authorization("authorization string"));
 * stream.open("http://www.boost.org");
 * @endcode
 *
 * @par Requirements
...
public:
   ...
   * Postcondition: <tt>value() == v</tt>
   */
  explicit authorization(const std::string& v)
    : value_(v)
  {
  }
